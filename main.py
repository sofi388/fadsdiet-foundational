...
targets = ['fad8_chol', 'fad8_crp'] #, 'fad8_ldlc', 'fad8_hdlc', 'fad8_tg', 'fad8_crp', 'fad8_hba1c', 
           # 'fad8_glauc', 'fad8_gluc0']
           #'fad8_ins0', 'fad8_ins30', 'fad8_ins120', 'fad8_glauc']
...
for target in targets:
    ...
    if target == 'fad8_crp':
        columns_to_drop = [col for col in ['Lnfad8_crp'] if col in X.columns]
        if columns_to_drop:
            X = X.drop(columns=columns_to_drop)
    ...
    # Drop outliers in the target variable
